        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.key}>
                  <Link
                    href={link.href}
                    className="text-gray-300 hover:text-[#5BB5B0] transition-colors text-sm"
                  >
                    {tNav(link.key)}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li>{t('phone')}</li>
              <li>
                <a href={`mailto:${t('email')}`} className="hover:text-[#5BB5B0] transition-colors">
                  {t('email')}
                </a>
              </li>
            </ul>
            <div className="mt-6">
              ...
              <div className="flex space-x-4 rtl:space-x-reverse">
                <a href="#" className="text-gray-300 hover:text-[#5BB5B0] transition-colors">
