...
// Adaa' Foundation Knowledge Products Page
...
// Sample publication data - replace with actual content
const publications = [
  {
    id: 1,
    title: "Institutional Performance Assessment Framework for Yemen's Water Utilities",
    type: "Assessment Report",
    date: "December 2025",
    description: "Comprehensive framework for evaluating operational efficiency, financial sustainability, and service delivery quality in conflict-affected utility systems.",
    tags: ["WASH", "Performance Management", "Public Utilities"],
    featured: true
  },
  {
    id: 2,
    title: "Anticipatory Action & Nutrition: A Roadmap for Yemen",
    type: "Policy Brief",
    date: "November 2025",
    description: "National roadmap for integrating nutrition considerations into anticipatory action frameworks, developed in collaboration with the Global Nutrition Cluster.",
    tags: ["Nutrition", "Climate Resilience", "Policy"],
    featured: true
  },
  {
    id: 3,
    title: "Digital Transformation in Humanitarian Response: Lessons from Yemen",
    type: "Working Paper",
    date: "October 2025",
    description: "Analysis of practical approaches to implementing digital solutions in low-bandwidth, resource-constrained humanitarian contexts.",
    tags: ["Digital Innovation", "Humanitarian", "Technology"],
    featured: false
  },
  {
    id: 4,
    title: "Third-Party Monitoring Best Practices in Complex Environments",
    type: "Technical Guide",
    date: "September 2025",
    description: "Practical guidance for implementing independent monitoring and verification in contexts with severe access constraints.",
    tags: ["M&E", "Third-Party Monitoring", "Methodology"],
    featured: false
  },
  {
    id: 5,
    title: "Localization in Practice: Strengthening Local CSO Capacity",
    type: "Case Study",
    date: "August 2025",
    description: "Documentation of institutional strengthening approaches for local civil society organizations, including compliance systems and governance frameworks.",
    tags: ["Localization", "Capacity Building", "CSOs"],
    featured: false
  }
];
...
const insights = [
  {
    id: 1,
    title: "The Triangle of Transformation: Culture, Process, and Business Intelligence",
    author: "Adaa Foundation Team",
    date: "January 2026",
    excerpt: "How understanding the interconnection between organizational culture, operational processes, and data-driven intelligence creates sustainable institutional change.",
    category: "Thought Leadership",
    readTime: "8 min read"
  },
  {
    id: 2,
    title: "AI in Humanitarian Contexts: Responsible Innovation for Yemen",
    author: "Adaa Foundation Team",
    date: "December 2025",
    excerpt: "Exploring practical applications of artificial intelligence in resource-constrained humanitarian settings while maintaining ethical standards.",
    category: "Innovation",
    readTime: "6 min read"
  },
  {
    id: 3,
    title: "Building Resilient M&E Systems in Conflict-Affected Areas",
    author: "Adaa Foundation Team",
    date: "November 2025",
    excerpt: "Lessons learned from designing and implementing monitoring and evaluation systems that adapt to volatile operational environments.",
    category: "Technical Insights",
    readTime: "10 min read"
  },
  {
    id: 4,
    title: "Data-Driven Decision Making for Water Utility Management",
    author: "Adaa Foundation Team",
    date: "October 2025",
    excerpt: "How systematic analysis of operational data revealed practical solutions for improving service delivery in Yemen's water sector.",
    category: "Case Study",
    readTime: "7 min read"
  }
];

// Sample news/media data
const newsItems = [
  {
    id: 1,
    title: "Adaa Foundation Partners with Global Nutrition Cluster on Anticipatory Action Training",
    date: "November 2025",
    type: "Press Release",
    excerpt: "Multi-day capacity strengthening program delivered to local and national actors on integrating nutrition into anticipatory action frameworks."
  },
  {
    id: 2,
    title: "New AI-Powered Health Awareness Platforms Launched",
    date: "October 2025",
    type: "Announcement",
    excerpt: "MUAFA+ and Afea4Community platforms now available, bringing accessible health knowledge to underserved populations across Yemen."
  },
  {
    id: 3,
    title: "Adaa Foundation Completes Mine Action Information Management System for UNDP",
    date: "September 2025",
    type: "Project Update",
    excerpt: "Comprehensive data collection tools, geographic mapping systems, and performance tracking dashboards delivered for mine action programming."
  }
];
...
const InsightCard = ({ insight }) => (
  <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300">
    ...
    <div className="p-6">
      ...
      {/* Title */}
      <h3 
        className="text-lg font-semibold mb-3 line-clamp-2 hover:underline cursor-pointer"
        style={{ color: colors.primaryNavy }}
      >
        {insight.title}
      </h3>
...
// News Card Component
const NewsCard = ({ news }) => (
  <div className="flex gap-4 p-4 bg-white rounded-lg border border-gray-100 hover:shadow-sm transition-all duration-300">
    {/* Date Badge */}
    <div 
    ...
    <div className="flex-1 min-w-0">
      ...
      <h4 
        className="font-semibold mb-1 line-clamp-1 hover:underline cursor-pointer"
        style={{ color: colors.primaryNavy }}
      >
        {news.title}
      </h4>
...
const TabButton = ({ active, icon, label, count, onClick }) => (
  <button
    ...
    style={{ 
      color: active ? colors.secondaryTeal : colors.bodyText
    }}
  >
    {icon}
    <span>{label}</span>
    {count && (
      <span 
        ...
        style={{ 
          backgroundColor: active ? `${colors.secondaryTeal}15` : colors.lightBg,
          color: active ? colors.secondaryTeal : colors.bodyText
        }}
      >
        {count}
...
// Main Knowledge Products Page Component
const AdaaKnowledgePage = () => {
  ...
  const filterOptions = [
    ...
    { value: 'brief', label: 'Policy Briefs' },
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 right-10 w-64 h-64 rounded-full" 
               style={{ backgroundColor: colors.secondaryTeal }} />
          <div className="absolute bottom-10 left-20 w-48 h-48 rounded-full" 
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-2 text-sm mb-6 opacity-80">
            ...
            <span style={{ color: colors.accentLightBlue }}>Knowledge Products</span>
          </div>
          ...
          >
            Access our latest publications, insights, and thought leadership on humanitarian response, development programming, and innovation in complex contexts.
          </p>
          ...
          <div className="max-w-xl mx-auto">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search publications, insights, and news..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-12 pr-4 py-3 rounded-lg text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2"
                style={{ 
                  backgroundColor: colors.white,
                  focusRing: colors.secondaryTeal
                }}
              />
          ...
          <div>
            ...
            <div className="text-center mt-10">
              <button 
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.backgroundColor = colors.secondaryTeal;
                  e.currentTarget.style.color = colors.white;
                }}
                onMouseOut={(e) => {
                  e.currentTarget.style.backgroundColor = 'transparent';
                  e.currentTarget.style.color = colors.secondaryTeal;
                }}
              >
          ...
          <div>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
              ...
              <div className="flex gap-2">
                {['All', 'Thought Leadership', 'Innovation', 'Technical Insights', 'Case Study'].map((cat, idx) => (
                  <button
                    key={idx}
                    className={`px-3 py-1 rounded-full text-sm transition-colors ${
                      idx === 0 ? 'text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                    }`}
                    style={idx === 0 ? { backgroundColor: colors.secondaryTeal } : {}}
                  >
                    {cat}
                  </button>
                ))}
            ...
            >
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <button 
                    className="flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium text-white transition-colors"
                    style={{ backgroundColor: colors.ctaOrange }}
                  >
                    Read Full Article
                    <ArrowRightIcon />
            ...
            >
              ...
              <p 
                ...
                style={{ color: colors.accentLightBlue }}
              >
                Subscribe to receive our latest insights, publications, and updates on humanitarian response and development in Yemen.
              </p>
        ...
        {activeTab === 'news' && (
          <div>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
              ...
              <div className="flex gap-2">
                {['All', 'Press Releases', 'Announcements', 'Project Updates'].map((type, idx) => (
                  <button
                    key={idx}
                    className={`px-3 py-1 rounded-full text-sm transition-colors ${
                      idx === 0 ? 'text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
            ...
            >
              ...
              <p className="text-sm text-gray-600 mb-4">
                Browse our complete archive of press releases, media coverage, and organizational updates.
              </p>
              <button 
                className="flex items-center gap-2 mx-auto px-4 py-2 rounded-lg font-medium transition-colors"
                style={{ 
                  color: colors.secondaryTeal,
                  backgroundColor: colors.white
                }}
            ...
            >
              ...
              <a 
                href="mailto:info@adaafoundation.org"
                className="text-sm font-medium"
                style={{ color: colors.ctaOrange }}
              >
                info@adaafoundation.org
              </a>
            </div>
          </div>
        )}
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Our team is available to discuss specific research needs, custom analysis, or potential collaboration on knowledge products.
          </p>
...
export default AdaaKnowledgePage;
